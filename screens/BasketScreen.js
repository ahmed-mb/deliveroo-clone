...
const BasketScreen = () => {
  ...
  //Group the list together and combine an array from the same restaurant within a single array
  useMemo(() => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b-2 border-[#00ccbb] bg-white shadow-xs">
          <View>
